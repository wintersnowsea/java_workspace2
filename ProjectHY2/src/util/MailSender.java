...
public class MailSender {
	...
	public void sendMail(String to) {
		...
		String subject="이메일인증번호"; //메일 제목
		String from ="zino1187@naver.com"; //보낸 사람 이메일
		String fromName="SoMi"; //보낸 사람
		//String to="haeyoung425@gamil.com"; //받을 사람 이메일, (콤마로 다수의 메일 가능)
		
		StringBuffer content=new StringBuffer();
		content.append("<h1>안녕하세요, SoMi입니다</h1>");
		content.append("<p>받으신 인증번호를 팝업창에 입력해주세요</p>");
	...
	public void sendMail(String to, String num) {
		...
		StringBuffer content=new StringBuffer();
		content.append("<h1>안녕하세요, SoMi입니다</h1>");
		content.append("<p>받으신 인증번호를 팝업창에 입력해주세요</p></br>");
