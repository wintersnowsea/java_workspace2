...
//Gallery 테이블과 관련된 CRUD를 담당하고
//JTable에게 정보를 제공해주는 역할의 객체
public class GalleryModel extends AbstractTableModel {
	...
	public void selectAll() {
		...
		try {
			pstmt=galleryMain.con.prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
