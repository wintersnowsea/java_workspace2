...
public class Hero extends GameObject {
	...
	public Hero(GamePanel gamePanel, int x, int y, int width, int height, int velX, int velY) {
		...
		image=imageManager.getImage("res/mon3.png", width, height);
	}
	...
	//Hero는 컴포넌트가 아니므로 그려질 수 없지만
	//JPanel인 GamePanel의 Graphics2D를 넘겨받아 왔으므로,
	//Hero에서 그려지는 모든 그래픽처리는 모두 GamePanel에 표현된다
